  ...
  return (
    ...
    <div className="py-5">
        ...
        <div className="container mx-auto p-5">
          <h3 class="font-bold text-xl mt-6 mb-1">Where does the money go?</h3>
          ...
          <h3 class="font-bold text-xl mt-6 mb-1">How do I get involved?</h3>
          ...
          <h3 class="font-bold text-xl mt-6 mb-1">So… who decides on the charity or NGO?</h3>
          ...
          <h3 class="font-bold text-xl mt-6 mb-1">I represent a Charity/NGO, how do I get involved?</h3>
          ...
          <h3 class="font-bold text-xl mt-6 mb-1">Where are the Charities/NGOs located?</h3>
          <p>We are a global community, coming together to change the world. There is no one central location.</p>

          <h3 class="font-bold text-xl mt-6 mb-1">What Blockchains are supported?</h3>
